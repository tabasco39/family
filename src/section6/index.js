                ...
                <div className='flex' style={{maxWidth:"1300px", justifyContent:'center', marginTop:'75px'  }}>
                    <div className="new_card">
                        ...
                        <div className="center">
                            <button className="btn-1 mt-3">Choose plan</button>
                        </div>
                    ...
                    <div className="new_card" style={{transform: 'translateY(-20px)'}}>
                        ...
                        <div className="center">
                            <button className="btn-1 mt-3" style={{backgroundColor:'#f5a973'}}>Choose plan</button>
                        </div>
                    </div>
                    <div className="new_card">
                        ...
                        <div className="center">
                            <button className="btn-1 mt-3" style={{backgroundColor:'#887fef'}}>Choose plan</button>
                        </div>
                    </div>
                </div>
                <div className="text-center">
